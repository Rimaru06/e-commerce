                    ...
                    <div className="md:py-8 ">
                        ...
                        <div className="mb-4 ">
                            <div className="flex  items-end gap-2">
                                ...
                                <span className="mb-0.5 text-red-500 line-through">Rs:{data.price + 5000}</span>
                        ...
                        <div className="flex gap-2.5 ">
                            <AddToBag currency="INR" description={data.description} price={data.price} image={data.images[0]} name={data.name} key={data._id} price_id={data.price_id} />
